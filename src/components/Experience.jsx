...
const experienceData = [
	{
		...
		description:
			'Conducting engaging training sessions for youth (7-17) on Hard & Soft Skills, including Python programming and AI concepts. My task organization involves preparing modular lesson plans, adapting content dynamically based on student progress using interactive tools, and providing structured feedback.',
		details: [
	...
	},
	{
		...
		description:
			'Performed administrative data analysis, ensuring data integrity and generating reports for election processes. Task organization involved meticulous planning of data validation steps, using checklists for quality control, and version controlling reports for accuracy and traceability.',
		details: [
		...
		logo: '/Photos/isie.png', // Added Election Authority logo
	},
	{
		...
		description:
			'Supervised field operations and conducted banking control tasks, ensuring compliance and efficiency. Managed team schedules and task assignments using spreadsheets and regular check-ins, prioritizing critical control points and documenting findings systematically.',
		details: [
		...
		logo: '/Photos/el amouri.png', // Added El Amouri logo
	},
];
